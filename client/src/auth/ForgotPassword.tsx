  ...
  return (
    <div className="flex items-center justify-center min-h-screen w-full">
        <form onSubmit={handleSubmit} className="flex flex-col gap-5 md:p-8 w-full max-w-md rounded-lg mx-4">
          ...
          {
            loading ? (
              <Button disabled className="bg-[var(--orange)] hover:bg-[var(--hoverOrange)]"><Loader2 className="mr-2 h-4 w-4 animate-spin"/>Please Wait</Button>
            ) : (
              <Button className="bg-[var(--orange)] hover:bg-[var(--hoverOrange)]">Send Reset Link</Button>
            )
          }
