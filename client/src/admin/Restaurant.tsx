...
const Restaurant = () => {
  ...
  //const loading = useRestaurantStore((state: any) => state.loading);
  //const createRestaurant = useRestaurantStore((state: any) => state.createRestaurant);
  const {
    loading,
    restaurant,
    updateRestaurant,
  ...
  const submitHandler = async (e: FormEvent<HTMLFormElement>) => {
    ...
    // add restaurant api imlementation start from here
    try {
